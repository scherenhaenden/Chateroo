...
let DeepseekEngine = class DeepseekEngine extends ai_api_engine_base_1.AiApiEngine {
    httpService;
    provider = 'deepseek';
    ...
    async sendMessage(payload) {
        ...
        try {
            ...
            console.error('Fehler bei der Kommunikation mit Deepseek:', error.response?.data || error.message);
            return { content: 'Sorry, there was an error communicating with Deepseek.' };
        }
    }
};
exports.DeepseekEngine = DeepseekEngine;
exports.DeepseekEngine = DeepseekEngine = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService])
], DeepseekEngine);
//# sourceMappingURL=deepseek.engine.js.map